...
namespace wage { namespace ecs {
  ...
  public:
    ...
    inline Reference<Component, ComponentId> assign(VersionedEntityId entityId, Args... args) {
    ...
    template <typename Component>
    inline Reference<Component, ComponentId> get(VersionedEntityId entityId) {
