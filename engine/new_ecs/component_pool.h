...
namespace wage { namespace ecs {
  ...
  class ComponentPool : public BaseComponentPool, public Reference<Component, ComponentId>::Source {

  public:

    class Item;

    typedef Reference<Component, ComponentId> ComponentReference;

    typedef typename ObjectPool<Item, ComponentId>::Iterator Iterator;
    ...
    //   View(ObjectPool<Item, ComponentId>* pool): pool(pool) {}
    ...
    private:
      friend class ComponentPool;
      friend class ObjectPool<Item, ComponentId>;
  ...
  private:
    ...
    Reference<Item, ComponentId> sparseRefs[MAX_ENTITY_ID];
