...
namespace wage::render::vulkan {
  ...
  void Texture::push(Device* device, CommandPool* commandPool, Pipeline* pipeline, VkDescriptorPool descriptorPool, int imageCount) {
    if (pushed) return;
  ...
  void Texture::createDescriptorSets(Device* device, CommandPool* commandPool, Pipeline* pipeline, VkDescriptorPool descriptorPool, int imageCount) {
