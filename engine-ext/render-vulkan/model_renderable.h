...
namespace wage {
  namespace render {
    ...
    public:
      ModelRenderable(asset::Manager* assetManager, render::MeshManager* meshManager, ModelManager* modelManager, math::Transform transform, MeshSpec* meshSpec, MaterialSpec* material)
