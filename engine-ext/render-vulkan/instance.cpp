...
namespace wage::render::vulkan {
  ...
  void Instance::create(bool enableValidationLayers) {
    ...
    if (vkCreateInstance(&createInfo, nullptr, &wrapped) != VK_SUCCESS) {
  ...
  void Instance::destroy() {
    if (enableValidationLayers) {
      DestroyDebugUtilsMessengerEXT(wrapped, debugMessenger, nullptr);
    }
  ...
  void Instance::setupDebugMessenger() {
    ...
    if (CreateDebugUtilsMessengerEXT(wrapped, &createInfo, nullptr, &debugMessenger) != VK_SUCCESS) {
