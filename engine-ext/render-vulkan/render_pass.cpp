...
namespace wage {
  namespace render {
    ...
    void RenderPass::create() {
      ...
      if (vkCreateRenderPass(device->logical, &renderPassInfo, nullptr, &wrapped) != VK_SUCCESS) {
        throw std::runtime_error("failed to create render pass!");
      }
    }

    void RenderPass::destroy() {
      vkDestroyRenderPass(device->logical, wrapped, nullptr);
    }

    void RenderPass::begin(VkCommandBuffer commandBuffer, int imageIndex) {
      VkRenderPassBeginInfo renderPassInfo{};
      renderPassInfo.sType = VK_STRUCTURE_TYPE_RENDER_PASS_BEGIN_INFO;
      renderPassInfo.renderPass = wrapped;
